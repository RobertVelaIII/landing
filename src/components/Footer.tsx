...
export default function Footer() {
  return (
    <footer id="footer" className="py-12 bg-black border-t border-neutral-800">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            <h3 className="text-lg mb-4 text-red-500 font-semibold">Connect</h3>
            <div className="flex space-x-4 mb-6">
              <span className="text-2xl text-white hover:text-red-400 transition-colors cursor-pointer">
            ...
            <div className="text-sm text-neutral-500">
              <span className="hover:text-neutral-300 transition-colors mr-4 cursor-pointer">Privacy Policy</span>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800 text-center text-neutral-500 text-sm">
          © 2025 Inkredible Tattoo Studio. All rights reserved.
        </div>
      </div>
    </footer>
  );
